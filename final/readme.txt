...
Model Core Classes:
1)updateAnimation: Shows the ball moving around the screen and interacting with the player placed walls

2)Game Over: Displays a game over message and player score when the player loses

3)isGameOver: Check to see if game is finished

4)startNewGameWithDifficulty: Starts a new game based on the chosen difficulty (number of blocks the player is given). Initializes level with ball in center and arrow showing direction of initial velocity

5)updateScore: Gets the score of the player
